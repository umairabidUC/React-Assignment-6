...
export const rowApiSlice = createApi({
    ...
    endpoints: builder => ({
        ...
        changeStatus: builder.mutation({
            query: ({ id, status }) => ({ url: `/topics/status/`, method: "PATCH", body: { id, status } }),
            invalidatesTags: ["Fetched Rows"]
        })
    })
})
...
export const { useGetRowsQuery, useAddRowsMutation, useEditRowMutation, useDeleteRowMutation, useChangeStatusMutation } = rowApiSlice